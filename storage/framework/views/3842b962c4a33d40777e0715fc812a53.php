...
<head>
    ...
    <title><?php echo e($title ?? 'Автопарк'); ?></title>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <?php if($role === 'admin'): ?>
                ...
                <a href="<?php echo e(route('vehicles.index')); ?>"
                   class="<?php echo e(request()->routeIs('vehicles.*') ? 'active' : ''); ?>">
                    <i class="bi bi-truck"></i> Машины
                </a>
            <?php endif; ?>

            <?php if($role === 'operator'): ?>
                <a href="<?php echo e(route('operator.vehicles')); ?>"
                   class="<?php echo e(request()->routeIs('operator.*') ? 'active' : ''); ?>">
                    <i class="bi bi-truck"></i> Все машины
                </a>

                <a href="<?php echo e(route('reports.maintenance')); ?>"
                   class="<?php echo e(request()->routeIs('reports.maintenance*') ? 'active' : ''); ?>">
                    <i class="bi bi-clipboard-data"></i> Затраты
                </a>

                <a href="<?php echo e(route('reports.needMaintenance')); ?>"
                   class="<?php echo e(request()->routeIs('reports.needMaintenance*') ? 'active' : ''); ?>">
                    <i class="bi bi-wrench-adjustable-circle"></i> Требуют ТО
                </a>
            <?php endif; ?>

            <?php if($role === 'driver'): ?>
                <a href="<?php echo e(route('driver.myvehicle')); ?>"
                   class="<?php echo e(request()->routeIs('driver.*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\210kab\Documents\Tarabanov\autopark\resources\views/layouts/app.blade.php ENDPATH**/ ?>