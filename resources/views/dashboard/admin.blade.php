    ...
    <div class="card card-modern p-4 mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-end small text-muted">
                <div>Сегодня: {{ now()->format('d.m.Y') }}</div>
            ...
            <div class="card card-modern p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold mb-0">{{ $vehiclesCount ?? '—' }}</h4>
                    </div>
            ...
            <div class="card card-modern p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold mb-0">{{ $maintenanceCount ?? '—' }}</h4>
                    </div>
            ...
            <div class="card card-modern p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold mb-0">{{ $driversCount ?? '—' }}</h4>
                    </div>
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card card-modern h-100 p-4">
                ...
                <ul class="list-unstyled small text-muted mb-3">
                    <li>Роль: <strong>{{ ucfirst(auth()->user()->role) }}</strong></li>
                    <li>Среда: <strong>{{ app()->environment() }}</strong></li>
                    <li>Laravel: <strong>{{ app()->version() }}</strong></li>
                </ul>
            </div>
        </div>
    ...
    @if(isset($lastLogs))
        <div class="card card-modern mt-5 p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('admin.logs') }}" class="btn btn-sm btn-outline-dark">
                    Журнал →
                </a>
            </div>
